...
@dag(tags=['crawler-task-history-gossip'], default_args=default_args, catchup=False,
     dag_id="crawler_task_history_gossip")
def dag_ptt_history_gossip():
    start_task = EmptyOperator(task_id="start_task")
    ptt_history_gossip = PythonOperator(task_id="crawl_ptt_history_gossip", python_callable=crawl_ptt_history_gossip)
    end_task = EmptyOperator(task_id="end_task")
    start_task >> ptt_history_gossip >> end_task


dag_ptt_history_gossip()
